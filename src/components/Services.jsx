  ...
  const services = [
    {
      ...
      description:
        "Professional CCTV installation for homes, offices, and commercial spaces with HD quality cameras.",
    ...
    },
    {
      ...
      description:
        "Advanced intercom and video door phone systems for enhanced security.",
    ...
    },
    {
      ...
      description:
        "Biometric attendance and access control systems for organizations.",
    ...
    },
    {
      ...
      description:
        "Modern electric door lock installation for smart security solutions.",
    ...
    },
    {
      ...
      description:
        "LED TV installation and mounting services for homes and offices.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            हमारी प्रोफेशनल टीम आपको देती है complete solution — Installation,
            Configuration, Maintenance aur Support तक।
          </p>
        </div>
        ...
        <div className="text-center mt-16 bg-gradient-to-r from-blue-50 to-emerald-50 rounded-2xl p-8 border border-blue-200">
          <h3 className="text-2xl font-bold text-slate-800 mb-4">
            "Hum sirf products nahi, full security solutions provide karte
            hain."
          </h3>
