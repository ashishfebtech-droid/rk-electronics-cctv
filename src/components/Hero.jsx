...
function Hero() {
  ...
  return (
    ...
    <section id="home" className="min-h-screen relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-emerald-50">
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between min-h-screen pt-24 pb-16 lg:pt-32 lg:pb-24">
          ...
          <div className={`lg:w-1/2 text-center lg:text-left transition-all duration-1000 transform ${
            ...
            <p className="text-lg text-slate-600 mb-8 leading-relaxed">
              हमारा mission है हर घर, ऑफिस और संस्था को modern technology से secure और smart बनाना।
            </p>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-6 text-sm text-slate-600 pt-6 border-t border-slate-200">
              <div className="flex items-center gap-2 justify-center lg:justify-start">
                ...
                <a href="tel:7248805027" className="hover:text-blue-600 font-semibold">7248805027</a>
              </div>
              <div className="flex items-center gap-2 justify-center lg:justify-start">
          ...
          <div className={`lg:w-1/2 mt-12 lg:mt-0 transition-all duration-1000 transform delay-300 ${
